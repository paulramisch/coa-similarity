...
IMG_HEIGHT = 96  # The images are already resized here
IMG_WIDTH = 96  # The images are already resized here
...
EMBEDDING_SHAPE = (1, 256, 3, 3)
# EMBEDDING_SHAPE = (1, 256, 16, 16)
# TEST_RATIO = 0.2

###### Test time #########
NUM_IMAGES = 10
TEST_IMAGE_PATH = "../data/coa/-1_O B lion rampant.jpg"
