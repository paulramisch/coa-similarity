...
ENCODER_MODEL_PATH = "models/deep_encoder{}.pt".format(REL_PATH, MODEL_NAME)
DECODER_MODEL_PATH = "models/deep_decoder{}.pt".format(REL_PATH, MODEL_NAME)
EMBEDDING_PATH = "models/data_embedding_f{}.npy".format(REL_PATH, MODEL_NAME)
IMG_DICT_PATH = "models/img_dict{}.pkl".format(REL_PATH, MODEL_NAME)
